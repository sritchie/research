...
** Third Way - Directional Derivative
...
distinct directions specified for each argument.

I think that specifying directions in a directional derivative is the key API
